...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet, BasicfooddataComponent,FooditemsummaryComponent,RatingPipe,GenderPipe, FoodcategorylistComponent, FoodcategoryshowcaseComponent,NavbarComponent],
