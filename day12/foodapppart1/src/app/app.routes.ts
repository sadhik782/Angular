...
import { FoodOrderReactiveFormsComponent } from './food-order-reactive-forms/food-order-reactive-forms.component';
...
export const routes: Routes = [
    ...
    { path: 'foodorderreactiveforms', component: FoodOrderReactiveFormsComponent},
